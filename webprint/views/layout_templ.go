...
func Layout() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<!doctype html><html><head><meta charset=\"utf-8\"><script src=\"/static/wasm/wasm_exec.js\"></script><script>\n\t\t\t\tconst go = new Go();\n\t\t\t\tWebAssembly.instantiateStreaming(fetch(\"/static/wasm/main.wasm\"), go.importObject).then((result) => {\n\t\t\t\t\tgo.run(result.instance);\n\t\t\t\t});\n\t\t\t</script></head><body>")
		if templ_7745c5c3_Err != nil {
